    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center py-20">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500 shadow-[0_0_15px_rgba(22,163,74,0.3)]"></div>
            </div>
        );
    }
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-zinc-100 shadow-rich h-fit">
                        ...
                        <form onSubmit={handleSubmit(onAddShop)} className="space-y-4">
                            ...
                            <button
                                ...
                                className="w-full py-4 bg-blue-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-blue-700 shadow-lg shadow-orange-500/20 active:scale-95 transition-all mt-4 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                        ...
                                        {isEditing ? (
                                            ...
                                            <>
                                                ...
                                                <div className="flex items-center gap-2 opacity-0 group-hover/shop:opacity-100 absolute right-5 transition-all translate-x-4 group-hover/shop:translate-x-0">
                                                    <button onClick={() => setViewingShop(shop)} className="p-2.5 bg-zinc-50 text-zinc-400 hover:text-blue-600 hover:bg-green-50 rounded-lg transition-all border border-zinc-100" title="View Details"><Eye className="w-4 h-4" /></button>
