                            ...
                            <div className="pt-6 border-t border-zinc-50">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-5 py-3 rounded-xl border ${errors.adminPassword ? 'border-rose-500/50 bg-rose-50/50' : 'border-zinc-100 bg-zinc-50'} text-zinc-900 text-sm font-bold outline-none focus:bg-white focus:border-green-500/40 transition-all`}
