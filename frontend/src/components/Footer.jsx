      ...
      <div className="max-w-7xl mx-auto px-8 py-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-3 group cursor-default">
            <div className="p-1.5 bg-blue-600 rounded-lg group-hover:scale-110 transition-transform duration-500 shadow-[0_0_15px_rgba(249,115,22,0.3)]">
          ...
          <div className="flex items-center gap-3 px-4 py-2 bg-[var(--color-surface-base)] rounded-full border border-[var(--color-border-subtle)] shadow-inner">
            ...
            <div className="w-1.5 h-1.5 rounded-full bg-blue-600/20 shadow-[0_0_8px_rgba(249,115,22,0.2)]"></div>
