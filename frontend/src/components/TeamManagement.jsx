            ...
            >
              <div className="flex items-start justify-between relative z-10">
                ...
                <div className="flex flex-col items-end gap-3 shrink-0 ml-4">
                  <span className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-[0.15em] border whitespace-nowrap ${u.role === 'admin' || u.role === 'shop_admin' || u.role === 'super_admin' ? 'bg-blue-600/10 text-blue-600 border-green-600/20' : 'bg-[var(--color-surface-base)] text-[var(--color-text-secondary)] border-[var(--color-border-subtle)]'}`}>
                    {u.role?.replace('_', ' ')}
                  </span>
                  <div className="flex gap-2">
                    <motion.button
                      ...
                      className="p-2.5 bg-white text-blue-600 rounded-xl transition-all border border-green-100 shadow-sm"
                      title="View Profile"
                    >
