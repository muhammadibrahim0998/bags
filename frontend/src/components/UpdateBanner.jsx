        ...
        <>
            ...
            >
                ...
                <div className="flex items-center justify-center gap-4 py-3 bg-[var(--color-surface-base)]/50 backdrop-blur-sm border border-[var(--color-border-subtle)] rounded-2xl relative z-10">
                    <div className="flex items-center gap-2 px-3 py-1 bg-blue-600/10 text-blue-600 rounded-lg border border-blue-600/20 shadow-sm shadow-blue-600/5 animate-pulse shrink-0">
                    ...
                    <div
                        ...
                        className="hidden sm:flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors ml-4 cursor-pointer shrink-0"
                    >
